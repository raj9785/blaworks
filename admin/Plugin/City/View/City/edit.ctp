        ...
        <div class="main-content" >
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Update City</h1>
                        </div>
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php echo $this->Form->input('lat',array('type' => 'hidden','name' => 'lat','value' => $users_data['City']['latitude'])); ?>
                            <?php echo $this->Form->input('lng',array('type' => 'hidden','name' => 'lng','value' => $users_data['City']['longitude'])); ?>
                            <br/>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->input('state_id', array('type' => 'select', 'empty' => 'Select','options' => $state_list, 'class' => 'form-control', 'id' => 'state_id', 'div' => false, 'label' => false, 'required' => true)); ?>
                                        <span id="phone_no-error" class="help-block"></span>
                                    </div>
                                     <div class="form-group">
