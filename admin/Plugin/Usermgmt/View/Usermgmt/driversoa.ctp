        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Driver SOA</h1>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 space20">
                            <div class="pull-left1 driver_index1">
                                ...
                                ?>
                                <a class="btn btn-green add-row new-style" href="<?php echo $this->Html->url(array('plugin' => 'usermgmt', 'controller' => 'usermgmt', 'action' => 'driversoa')); ?>">Reset</a>			
                                <?php
                                            ...
                                            <div class="dropdown" style='float:left'>
                                                ...
                                                <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                    <li>
                                                        ...
                                                        <?php
                                                        echo $this->Html->link('' . __('View Statement of Account', true), array('plugin' => 'usermgmt', 'controller' => 'usermgmt', 'action' => 'driver_payment', $records[$model]['uniqid']), array('class' => '', 'escape' => false));
                                                        ?>
