<div id="AD_<?php echo $count ?>" class="col-sm-12"  style="margin-bottom: 13px;"> 
	...
	<div class="">  
	    <div class="col-sm-3">
		<?php echo $this->Form->select('OperationCity.state_id.' . $count, $state, array('value' => $state_id, 'class' => "form-control input-sm validate[required]", 'empty' => "Select State",'style' => "width:100% !important")); ?>						
	    </div>
	    <div class="col-sm-3">
		<?php echo $this->Form->select('OperationCity.city_id.' . $count, $city, array('class' => "form-control input-sm validate[required]", 'empty' => "Select City", "value" => $city_id,'style' => "width:100% !important")); ?>					
	    </div><?php /* ?>
	    <div class="col-sm-3">
		<input type="text" id="OperationCityGarageAddress<?php echo $count ?>" value="<?php echo $address; ?>" placeholder="Garage Address" class="gmap_garag_address form-control input-sm" style="width:100% !important" name="data[OperationCity][garage_address][<?php echo $count ?>]" autocomplete="off">
	...
	<div class="col-sm-10"> 
	    <div class="col-sm-12">  
			<div id="show_map_canvas<?php echo $count ?>" ></div>
	    </div>
	</div>
    </div>   
    <script>
