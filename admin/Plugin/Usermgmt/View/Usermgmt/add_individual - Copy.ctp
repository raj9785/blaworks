...
echo $this->Html->script(array('jquery.validationEngine-en', 'jquery.validationEngine', 'plugins/moment/moment', 'plugins/datetimepicker/build/js/bootstrap-datetimepicker.min', 'add_individual', 'https://maps.googleapis.com/maps/api/js?libraries=places&sensor=false', 'geocomplete.js'));
?>
<?php
