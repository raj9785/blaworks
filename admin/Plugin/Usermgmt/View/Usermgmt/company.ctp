...
<table class="table table-bordered table-striped">
	...
	<h1><?php echo __($pageHeading, true); ?><div class="pull-right">
		...
		if (authComponent::user('user_role_id') == 1) {
		    echo $this->Html->link('<i class="icon-plus icon-white"></i> ' . __('Add', true), array('action' => 'add_company'), array('class' => 'btn btn-primary', 'escape' => false));
		}
		?> 
...
<tr>
	...
	<div class=" pull-right">
	    ...
	    echo $this->Form->text('username', array('placeholder' => __('Search By Username', true), 'class' => 'input-medium'));
				...
				<div class="dropdown" style='float:left'>
					...
					<?php if (authComponent::user('user_role_id') == 1) { ?>
	    				<li><?php if ($records[$model]['status'] == 1) { ?>
						    <a href='javascript::void(0)' onclick='return show_message("Are you sure you want to inactivate this company?", this);' id='inactive_<?php echo $records[$model]['id']; ?>' class='' data-toggle="tooltip" data-placement="top" title="Click here to inactivate."><i class="icon-ok-sign icon-black"></i><?php echo __("Inactivate"); ?></a>

						<?php } else { ?>
						    <a href='javascript::void(0)' onclick='return show_message("Are you sure you want to activate this company?", this);' id='inactive_<?php echo $records[$model]['id']; ?>' class='' data-toggle="tooltip" data-placement="top" title="Click here to activate."><i class="icon-ok-sign icon-black"></i> <?php echo __("Activate"); ?></a>


						<?php } ?>
	    				</li>
	    				<li>
	    				    <a href='javascript::void(0)' onclick='return delete_user("Are you sure you want to delete this company?", this);' id='delete_<?php echo $records[$model]['id']; ?>' class='' data-toggle="tooltip" data-placement="top" title="Click here to delete."><i class="icon-trash icon-black"></i> <?php echo __("Delete"); ?></a>
	    				</li>
					<?php } ?>
