...
<script type="text/javascript">
    ...
    $("#check_all_f").on("click", function() {
            $("input[id^=job_category_id]").each(function() {
        ...
        jQuery("#TrainingCategoryEditForm").validationEngine();
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <div class="container-fluid container-fullw bg-white">
                     <?php
                    echo $this->Form->create($model, array('url' => array('plugin' => 'training_category', 'controller' => 'training_categories', 'action' => 'edit'), 'enctype' => 'multipart/form-data'));
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <img src="<?php echo HTTP_PATH_CATEGORY_ICONS.$record['TrainingCategory']['icon']; ?>"  width="150px" class="img-rounded"/>
                                    </div>
                                </div>
