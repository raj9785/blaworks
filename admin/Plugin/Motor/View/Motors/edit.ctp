...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery("#MotorEditForm").validationEngine();
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle"> Update Vehicle Manufacturer</h1>
                        </div>
                        <div class="col-md-4 text-align-right">
                            <?php echo $this->Html->link("<i class=\"icon-arrow-left icon-white\"></i>" . __('Back to Vehicle Manufacturers List', true) . "", array("action" => "index"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    <?php
                    echo $this->Form->create($model, array('url' => array('plugin' => 'motor', 'controller' => 'motors', 'action' => 'edit'), 'enctype' => 'multipart/form-data'));
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php
                                        echo $this->Form->label($model . '.name', __('Vehicle Manufacturer Name', true) . ' :<span class="symbol required"></span>', array('style' => ""));
                                        ?>
