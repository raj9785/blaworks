...
$( "#delete_user_div").dialog({
			...
			buttons:{
				...
				$.ajax({
					url: "<?php echo $this->Html->url(array('plugin' => 'farecategory','controller' => 'farecategories','action' => 'admin_delete')); ?>",
					data: {'id':user_id},
					type: 'post',
					success: function(r){
						if(r=='error'){
			...
			<td>
				...
				<div class="row" style="padding:7px 33px;">
					<div class="clearfx control-group">
						...
						?>
						<div class="input" style="margin-left:150px;" >
							<?php echo $category_result[$model]['created'];?>
						</div>
					</div>
				</div>
				<div class="row" style="padding:7px 33px;">
					<div class="clearfx control-group">
						...
						?>
						<div class="input" style="margin-left:150px;" >
							<?php echo $category_result[$model]['modified'];?>
						</div>
					</div>
				</div>
			</td>
