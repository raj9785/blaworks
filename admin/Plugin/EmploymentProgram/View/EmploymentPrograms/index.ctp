        ...
        swal({
            ...
            closeOnConfirm: false,
                ...
                function() {
                    $.ajax({
                        type: 'post',
                        url: '<?php echo $this->Html->url(array('plugin' => 'employment_program', 'controller' => 'employment_programs', 'action' => 'change_status')); ?>',
                        data: {
                            'id': id,
                            'status': status,
                        },
                ...
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-align-right">						
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i> ' . __('Add New Employment Program', true) . "", array('plugin' => "employment_program", 'controller' => 'employment_programs', "action" => "add"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
					    ...
					    $i = $count - $limit * ($page - 1);
                            ...
                            <tr style="height:30px;" class="gallerytr">
                                ...
                                <td>
                                            ...
                                            if (is_file(JOB_WBROOT_PATH_ICONS . $file_name)) {
                                                ?>
                                    <img src="<?php echo HTTP_PATH_JOB_ICONS . $records[$model]['image']; ?>" width="75px"  class="img-rounded" />
                                                <?php
                                            }
                                            ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown" style='float:left'>
                                        ...
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                            <li> <?php
                                                        echo $this->Html->link(__('Edit', true), array('plugin' => 'employment_program', 'controller' => 'employment_programs', 'action' => 'edit', $records[$model]['id']), array('class' => '', 'escape' => false));
                                                        ?>
                                            </li>
