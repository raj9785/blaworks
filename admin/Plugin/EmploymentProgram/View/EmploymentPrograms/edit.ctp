...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery("#EmploymentProgramEditForm").validationEngine();
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-align-right">	
                            <?php echo $this->Html->link("<i class=\"icon-arrow-left icon-white\"></i>" . __('Back to Employment Program List', true) . "", array("action" => "index"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
                ...
                <div class="container-fluid container-fullw bg-white">
                     <?php
                    echo $this->Form->create($model, array('url' => array('plugin' => 'employment_program', 'controller' => 'employment_programs', 'action' => 'edit'), 'enctype' => 'multipart/form-data'));
...
<!--                                <div class="col-md-6">
				        ...
				        <img src="<?php echo HTTP_PATH_JOB_ICONS.$record['EmploymentProgram']['image']; ?>" width="150px"  class="img-rounded"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>">
                                        ...
                                        <div class="input <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>" style="" >
                                            ...
                                            <?php echo $this->Form->text("LanguageMapEmploymentProgram.".$lang['Language']['id'].".name", array('class' => 'form-control textbox '.$req)); ?>
				...
				?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>">
                                        <label for="districtName" style="">Description (<?php echo $lang['Language']['name']; ?>) :<span class="symbol required"></span></label>
                                        <div class="input <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>" style="" >
										    <?php 
											if($lang['Language']['id']==1){
												$req=" validate[required]";
                                            ...
                                            <?php echo $this->Form->textarea("LanguageMapEmploymentProgram.".$lang['Language']['id'].".description", array('class' => 'form-control textbox '.$req)); ?>
                                            <span class="help-inline" style="color: #B94A48;">
