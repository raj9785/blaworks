...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery("#EmploymentProgramAddForm").validationEngine();
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <div class="container-fluid container-fullw bg-white">
                    <?php echo $this->Form->create($model, array('url' => array('plugin' => 'employment_program', 'controller' => 'employment_programs', 'action' => 'add'), 'enctype' => 'multipart/form-data')); ?>
