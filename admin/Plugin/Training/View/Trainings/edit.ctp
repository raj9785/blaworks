...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        jQuery("#TrainingEditForm").validationEngine();
    ...
    function get_state() {
        $.ajax({
            type: 'POST',
            url: '<?php echo $this->Html->url(array('plugin' => 'training', 'controller' => 'trainings', 'action' => 'get_district_list')) ?>',
            data: {'state_id': '<?php echo $record['Training']['state_id']; ?>', 'district_id': '<?php echo $record['Training']['district_id']; ?>'},
            success: function(data) {
                $("#submit_button").removeAttr('disabled');
                $("#district_id").removeAttr('disabled');
                $("#district_id").html(data);
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <div class="container-fluid container-fullw bg-white">
                     <?php
                    echo $this->Form->create($model, array('url' => array('plugin' => 'training', 'controller' => 'trainings', 'action' => 'edit'), 'enctype' => 'multipart/form-data'));
