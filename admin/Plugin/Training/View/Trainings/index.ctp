        ...
        swal({
            ...
            closeOnConfirm: false,
                ...
                function() {
                    $.ajax({
                        type: 'post',
                        url: '<?php echo $this->Html->url(array('plugin' => 'training', 'controller' => 'trainings', 'action' => 'change_status')); ?>',
                        data: {
                            'id': id,
                            'status': status,
                        },
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-align-right">						
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i> ' . __('Add New Training', true) . "", array('plugin' => "training", 'controller' => 'trainings', "action" => "add"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    echo $this->Form->select('Training.state_id', $state_list, array('empty' => __('Select State', true),'value'=>@$state_id, 'class' => ' form-control input-sm')) . '&nbsp;';
                    echo $this->Form->select('Training.training_category_id', $trainingcat_list, array('empty' => __('Select Category', true),'value'=>@$training_category_id, 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                    ...
                    ?>&nbsp;&nbsp;<a class="btn btn-green add-row" href="<?php echo $this->Html->url(array('plugin' => 'training', 'controller' => 'trainings', 'action' => 'index')); ?>">Reset</a>
                    ...
                    <table class="table table-striped table-bordered  table-full-width">
                        <thead>
                            <tr style="height:30px;">
                                ...
                                <th class="hidden-xs">Last Date Apply</th>
					...
					if ($page == 0 || $page == 1) {
					    ...
					    $i = $count - $limit * ($page - 1);
                            ...
                            <tr style="height:30px;" class="gallerytr">
                                ...
                                <td>
                                            <?php echo $records[$model]['training_name']; ?>
                                </td>
                                <td>
                                            <?php echo $records['TrainingCategory']['title']; ?>
                                </td>
                                <td>
                                            <?php echo $records[$model]['last_date_apply']; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown" style='float:left'>
                                        ...
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                            <li> <?php
                                                        echo $this->Html->link(__('Edit', true), array('plugin' => 'training', 'controller' => 'trainings', 'action' => 'edit', $records[$model]['id']), array('class' => '', 'escape' => false));
                                                        ?>
                                            </li>
