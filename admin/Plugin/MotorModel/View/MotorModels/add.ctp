...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $("#submit_button").on("click",function(){
           ...
           if($("#MotorModelImage").val() == ""){
               alert("Please select vehicle image to upload");
               $("#MotorModelImage").focus();
               return false;
           }
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-10">
                            <h1 class="mainTitle"> Add New Vehicle Model</h1>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="container-fluid container-fullw bg-white">
                    <?php
                    echo $this->Form->create($model, array('url' => array('plugin' => 'motor_model', 'controller' => 'motor_models', 'action' => 'add'), 'enctype' => 'multipart/form-data'));
                    ?>         
                    <div class="row">
                        <div class="col-md-12">		    
                            ...
                            <div class="row" style="">
                                <div class="col-md-6">	
                                    <div class="form-group <?php echo ($this->Form->error('motor_type_id')) ? 'error' : ''; ?>">
                                        <?php
                                        echo $this->Form->label($model . '.motor_id', __('Vehicle Type', true) . ' :<span class="symbol required"></span>', array('style' => ""));
                                        ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group <?php echo ($this->Form->error('image')) ? 'error' : ''; ?>">
                                        ...
                                        <div class="input <?php echo ($this->Form->error('image')) ? 'error' : ''; ?>" style="" >
                                            <?php echo $this->Form->input($model . ".image", array('class' => 'validate[required]', 'type' => 'file', 'label' => false, 'div' => false, 'required' => true)); ?>
                                            <span class="help-inline" style="color: #B94A48;">
