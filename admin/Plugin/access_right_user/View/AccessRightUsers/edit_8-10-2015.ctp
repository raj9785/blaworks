...
<script type="text/javascript">
    jQuery(document).ready(function() {
		jQuery("#AccessRightUserEditForm").validationEngine();
	});
</script>
<div id="app">
    <!-- sidebar -->
	...
	<div class="main-content">
		...
		<section id="page-title">
		    <div class="row">
			<div class="col-sm-10">
			    <h1 class="mainTitle">Edit User & Permissions</h1>
			</div>
			<div class="col-md-2">
		...
		<div class="container-fluid container-fullw bg-white">
		    <?php
		    echo $this->Form->create($model, array('url' => array('plugin' => 'access_right_user', 'controller' => 'access_right_users', 'action' => 'edit',$cate_id,$id), 'enctype' => 'multipart/form-data'));
			...
			<div class="col-md-12">
				...
				<div class="col-md-6">
					...
					<?php
					$errorval 	= '';
					$txtval 	= isset($this->data['AccessRightUser']['username']) ? $this->data['AccessRightUser']['username'] : '';
					...
					<div class="input <?php echo ($this->Form->error('username')) ? 'error' : ''; ?>" style="" >
						...
						<?php
								if($this->Session->check('errors')){
									$sessionval = $this->Session->read('errors');
									echo isset($sessionval['username'][0]) ? $sessionval['username'][0] : '';
				   ...
				   <div class="form-group <?php echo ($this->Form->error('password')) ? 'error' : ''; ?>">
					...
					<div class="input <?php echo ($this->Form->error('password')) ? 'error' : ''; ?>" style="" >
					    <?php echo $this->Form->password($model . '.password', array("class" => "form-control textbox")); ?>
					    <span class="help-inline" style="color: #B94A48;">
					...
					<div class="input <?php echo ($this->Form->error('confirm_password')) ? 'error' : ''; ?>" style="" >
					    <?php echo $this->Form->password($model . '.confirm_password', array("class" => "form-control textbox validate[equals[AccessRightUserPassword]]")); ?>
					    <span class="help-inline" style="color: #B94A48;">
