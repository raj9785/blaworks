        ...
        swal({
            ...
            closeOnConfirm: false,
                ...
                function() {
                    $.ajax({
                        type: 'post',
                        url: '<?php echo $this->Html->url(array('plugin' => 'job', 'controller' => 'jobs', 'action' => 'change_status')); ?>',
                        data: {
                            'id': id,
                            'status': status,
                        },
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-align-right">						
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i> ' . __('Add New Job', true) . "", array('plugin' => "job", 'controller' => 'jobs', "action" => "add"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    echo $this->Form->text('Job.code', array('placeholder' => __('Search By Code', true),'value'=>@$code ,'style' => 'width: 126px;','class' => 'form-control input-sm')) . '&nbsp;';
                    echo $this->Form->select('Job.state_id', $state_list, array('empty' => __('Select State', true),'value'=>@$state_id, 'class' => ' form-control input-sm')) . '&nbsp;';
                    echo $this->Form->select('Job.job_category_id', $jobcat_list, array('empty' => __('Select Category', true),'value'=>@$job_category_id, 'class' => ' form-control input-sm')) . '&nbsp;&nbsp;';
                    ...
                    ?>&nbsp;&nbsp;<a class="btn btn-green add-row" href="<?php echo $this->Html->url(array('plugin' => 'job', 'controller' => 'jobs', 'action' => 'index')); ?>">Reset</a>
...
<!--                                <th class="hidden-xs">Education</th>-->
					...
					if ($page == 0 || $page == 1) {
					    ...
					    $i = $count - $limit * ($page - 1);
                            ...
                            <tr style="height:30px;" class="gallerytr">
                                ...
                                <td>
                                            <?php echo $records['JobCategory']['title']; ?>
                                </td>
                                <td>
                                            <?php echo @$records['JobDetail'][0]['company_profile']; ?>
                                </td>
                                <td>
                                            <?php echo $records['State']['name']; ?>
                                </td>
<!--                                <td>
                                            <?php //echo $records['Education']['name']; ?>
                                </td>-->
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown" style='float:left'>
                                        ...
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                            <li> <?php
                                                        echo $this->Html->link(__('Edit', true), array('plugin' => 'job', 'controller' => 'jobs', 'action' => 'edit', $records[$model]['id']), array('class' => '', 'escape' => false));
                                                        ?>
                                            </li>
