...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery("#StateAddForm").validationEngine();
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <div class="container-fluid container-fullw bg-white">
                    <?php echo $this->Form->create($model, array('url' => array('plugin' => 'state', 'controller' => 'states', 'action' => 'add'), 'enctype' => 'multipart/form-data')); ?>
								...
								<?php foreach($language_list as $lang){
                                    ...
                                    <div class="form-group <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>">
                                        ...
                                        <div class="input <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>" style="" >
                                            ...
                                            <?php echo $this->Form->text("LanguageMapState.".$lang['Language']['id'].".name", array('class' => 'form-control textbox '.$req)); ?>
                                            <span class="help-inline" style="color: #B94A48;">
