        ...
        swal({
            ...
            closeOnConfirm: false,
                ...
                function () {
                    $.ajax({
                        type: 'post',
                        url: '<?php echo $this->Html->url(array('plugin' => 'state', 'controller' => 'states', 'action' => 'change_status')); ?>',
                        data: {
                            'id': id,
                            'status': status,
                        },
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle"><?php  echo $title_for_layout.' : '.$state_name;?></h1>
                        </div>
                        <div class="col-sm-4 text-align-right">						
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i> ' . __('Add New State', true) . "", array('plugin' => "state", 'controller' => 'states', "action" => "add"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
                            ...
                            if (!empty($result)) {
                                ...
                                foreach ($result as $records) {
                                    ...
                                    <tr style="height:30px;" class="gallerytr">
                                        <td><?php echo $i; ?></td>
										<td>
                                            <?php echo $records['Language']['name']; ?>
                                        </td>
                                        <td>
                                            <?php echo $records['LanguageMapState']['content']; ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown" style='float:left'>
                                                ...
                                                <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                                    <li> <?php
                                                        echo $this->Html->link(__('Edit', true), array('plugin' => 'state', 'controller' => 'states', 'action' => 'edit', $records['LanguageMapState']['id']), array('class' => '', 'escape' => false));
                                                        ?>
                                                    </li>
