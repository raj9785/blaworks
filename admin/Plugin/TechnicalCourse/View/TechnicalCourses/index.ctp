        ...
        swal({
            ...
            closeOnConfirm: false,
                ...
                function() {
                    $.ajax({
                        type: 'post',
                        url: '<?php echo $this->Html->url(array('plugin' => 'technical_course', 'controller' => 'technical_courses', 'action' => 'change_status')); ?>',
                        data: {
                            'id': id,
                            'status': status,
                        },
                ...
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-align-right">						
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i> ' . __('Add New Technical Course', true) . "", array('plugin' => "technical_course", 'controller' => 'technical_courses', "action" => "add"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
					...
					if ($page == 0 || $page == 1) {
					    ...
					    $i = $count - $limit * ($page - 1);
                            ...
                            <tr style="height:30px;" class="gallerytr">
                                ...
                                <td>
                                            <?php echo date(DATETIME_FORMAT, strtotime($records[$model]['created_on'])); ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown" style='float:left'>
                                        ...
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                            <li> <?php
                                                        echo $this->Html->link(__('Edit', true), array('plugin' => 'technical_course', 'controller' => 'technical_courses', 'action' => 'edit', $records[$model]['id']), array('class' => '', 'escape' => false));
                                                        ?>
                                            </li>
