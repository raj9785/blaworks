...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery("#TechnicalCourseAddForm").validationEngine();
    });
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <div class="container-fluid container-fullw bg-white">
                    <?php echo $this->Form->create($model, array('url' => array('plugin' => 'technical_course', 'controller' => 'technical_courses', 'action' => 'add'), 'enctype' => 'multipart/form-data')); ?>
