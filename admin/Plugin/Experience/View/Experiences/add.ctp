...
<script type="text/javascript">
    jQuery(document).ready(function() {
        jQuery("#ExperienceAddForm").validationEngine();
        $("#range_type").on("change",function(){
            if($(this).val()==2){
                $(".max_range_class").hide();
                $("#ExperienceMaxRange").removeClass("validate[required]");
            }else{
                $(".max_range_class").show();
                $("#ExperienceMaxRange").addClass("validate[required]");
            }
        });
    });
                ...
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-align-right">	
                            <?php echo $this->Html->link("<i class=\"icon-arrow-left icon-white\"></i>" . __('Back to Experience List', true) . "", array("action" => "index"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
                <?php echo $this->Session->flash(); ?>
                <div class="container-fluid container-fullw bg-white">
                    <?php echo $this->Form->create($model, array('url' => array('plugin' => 'experience', 'controller' => 'experiences', 'action' => 'add'), 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label">Select Experience Type <span class="symbol required"></span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group <?php echo ($this->Form->error('min_range')) ? 'error' : ''; ?>">
                                        <?php
                                        echo $this->Form->label($model . '.min_range', __('Minimum (Months)', true) . ' :<span class="symbol required"></span>', array('style' => ""));
                                        ?>
                                ...
                                <div class="col-md-6 max_range_class">
                                    <div class="form-group <?php echo ($this->Form->error('max_range')) ? 'error' : ''; ?>">
                                        <?php
                                        echo $this->Form->label($model . '.max_range', __('Maximum (Months)', true) . ' :<span class="symbol required"></span>', array('style' => ""));
                                        ?>
					...
					<?php foreach($language_list as $lang){
                                ...
                                <div class="col-md-6">
                                    <div class="form-group <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>">
                                        <label for="ExperienceName" style="">Name (<?php echo $lang['Language']['name']; ?>) :<span class="symbol required"></span></label>
                                        <div class="input <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>" style="" >
                                            ...
                                            <?php echo $this->Form->text("LanguageMapExperience.".$lang['Language']['id'].".name", array('class' => 'form-control textbox '.$req)); ?>
                                            <span class="help-inline" style="color: #B94A48;">
