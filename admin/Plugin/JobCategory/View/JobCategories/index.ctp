        ...
        swal({
            ...
            closeOnConfirm: false,
                ...
                function() {
                    $.ajax({
                        type: 'post',
                        url: '<?php echo $this->Html->url(array('plugin' => 'job_category', 'controller' => 'job_categories', 'action' => 'change_status')); ?>',
                        data: {
                            'id': id,
                            'status': status,
                        },
                ...
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-align-right">						
                            <?php echo $this->Html->link('<i class="fa fa-plus"></i> ' . __('Add New Job Category', true) . "", array('plugin' => "job_category", 'controller' => 'job_categories', "action" => "add"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
					...
					if ($page == 0 || $page == 1) {
					    ...
					    $i = $count - $limit * ($page - 1);
                            ...
                            <tr style="height:30px;" class="gallerytr">
                                ...
                                <td>
                                            <?php
                                            $file_name = $records[$model]['icon'];
                                            if (is_file(CATEGORY_WBROOT_PATH_ICONS . $file_name)) {
                                                ?>
                                    <img src="<?php echo HTTP_PATH_CATEGORY_ICONS . $records[$model]['icon']; ?>" width="75px"  class="img-rounded" />
                                                <?php
                                            }
                                            ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="dropdown" style='float:left'>
                                        ...
                                        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                            <li> <?php
                                                        echo $this->Html->link(__('Edit', true), array('plugin' => 'job_category', 'controller' => 'job_categories', 'action' => 'edit', $records[$model]['id']), array('class' => '', 'escape' => false));
                                                        ?>
                                            </li>
