...
<script type="text/javascript">
    jQuery(document).ready(function () {
        ...
        jQuery("#DistrictEditForm").validationEngine();
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4 text-align-right">	
                            <?php echo $this->Html->link("<i class=\"icon-arrow-left icon-white\"></i>" . __('Back to District List', true) . "", array("action" => "index"), array("class" => "btn btn-green add-row", "escape" => false)); ?>
                        </div>
                    </div>
                </section>
                ...
                <div class="container-fluid container-fullw bg-white">
                     <?php
                    echo $this->Form->create($model, array('url' => array('plugin' => 'district', 'controller' => 'districts', 'action' => 'edit'), 'enctype' => 'multipart/form-data'));
								...
								<?php foreach($language_list as $lang){
                                    ...
                                    <div class="form-group <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>">
                                        ...
                                        <div class="input <?php echo ($this->Form->error('name')) ? 'error' : ''; ?>" style="" >
                                            ...
                                            <?php echo $this->Form->text("LanguageMapDistrict.".$lang['Language']['id'].".content", array('class' => 'form-control textbox '.$req)); ?>
