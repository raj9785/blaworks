                ...
                <div class="container-fluid container-fullw bg-white">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php echo $this->Form->input('lat',array('type' => 'hidden','name' => 'lat','value' => $users_data['Locality']['latitude'])); ?>
                            <?php echo $this->Form->input('lng',array('type' => 'hidden','name' => 'lng','value' => $users_data['Locality']['longitude'])); ?>
                            <br/>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->input('city_id', array('type' => 'select', 'empty' => 'Select','options' => $city_list, 'class' => 'form-control', 'id' => 'city_id', 'div' => false, 'label' => false, 'required' => true)); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->input('state_id', array('type' => 'select', 'empty' => 'Select','options' => $states_list, 'class' => 'form-control', 'id' => 'state_id', 'div' => false, 'label' => false, 'required' => true)); ?>
                                        <span id="phone_no-error" class="help-block"></span>
                                    </div>
                                    <div class="form-group">
