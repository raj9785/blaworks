...
<script type="text/javascript">
    jQuery(document).ready(function() {
       get_state();
        ...
        jQuery("#PanchayatEditForm").validationEngine();
    ...
    function get_state() {
        $.ajax({
            ...
            data: {'state_id': '<?php echo $record['Panchayat']['state_id']; ?>', 'district_id': '<?php echo $record['Panchayat']['district_id']; ?>'},
        ...
        $.ajax({
            ...
            data: {'district_id': '<?php echo $record['Panchayat']['district_id']; ?>', 'block_id': '<?php echo $record['Panchayat']['block_id']; ?>'},
            success: function(data) {
                $("#submit_button").removeAttr('disabled');
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <div class="container-fluid container-fullw bg-white">
                     <?php
                    echo $this->Form->create($model, array('url' => array('plugin' => 'panchayat', 'controller' => 'panchayats', 'action' => 'edit'), 'enctype' => 'multipart/form-data'));
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->input('block_id', array('type' => 'select','disabled'=>true,  'empty' => 'Select','options' => array(), 'class' => 'form-control  validate[required]', 'id' => 'block_id', 'div' => false, 'label' => false, 'required' => true)); ?>
                                        <span id="name-error" class="help-block"></span>
                                    </div>
